...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <a href="<?= base_url('Pengguna/cPinjam/pinjam') ?>" class="btn btn-default mb-3">
                        <i class="fas fa-university"></i> Pinjam Asset
                    </a>
                    <div class="card">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $value->kondisi ?>
                                        <br>
                                        <?php if ($value->status_dipinjam == '0') {
                                                                    ?>
                                                    <span class="badge badge-warning">Available</span>
                                                <?php
                                                                    } else if ($value->status_dipinjam == '1') {
                                                ?>
                                                    <span class="badge badge-info">Dibooking</span>
                                                <?php
                                                                    } else if ($value->status_dipinjam == '2') {
                                                ?>
