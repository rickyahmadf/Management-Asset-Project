...
.cool-text {
    font-family: "Lobster", sans-serif;/* Mengatur jenis font */
...
.submit-button {
        ...
        .callout-danger::before {
            ...
            top: 10px;
            left: 10px;
            color: #721c24; /* Warna simbol peringatan */
        }
        ...
        .callout-success::before {
            ...
            top: 10px;
            left: 10px;
            color: #155724; /* Warna simbol centang */
        }
...
<body>
<div class="cool-text">
<b>Selamat Datang Di <br> Sistem Informasi Manajemen Aset</b>
</div>
<div class="container">
...
<?php
    ...
    <div class="login-box">
                ...
                <form action="<?= base_url('cAuth') ?>" method="post">
                    ...
                    <a href="<?= base_url('Admin/cKelolaData/registrasi') ?>"><center>already account? register sekarang!</center></a>
