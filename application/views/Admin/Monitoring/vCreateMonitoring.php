...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Data Pengecekan Asset</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Pengecekan Asset</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-md-8">
                <div class="card card-outline card-info">
                    <div class="card-header">
                        <h3 class="card-title">
                            Pengecekan Data
                            <small>Masukkan Data Pengecekan</small>
                        </h3>
                        <!-- tools box -->
                    ...
                    <div class="card-body pad">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="asset">
                                ...
                                ?>
                                    <option value="<?= $value->id_asset ?>"><?= $value->nama_barang ?> </option>
                                <?php
                                }
                                ?>
                            </select>
                        ...
                        <div class="mb-3">
                            <label for="exampleInputPassword1">Hasil Pengecekan</label>
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">Gambar Kondisi Pengecekan</label>
