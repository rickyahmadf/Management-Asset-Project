                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?php
                                                ...
                                                ?>
                                                    <span class="badge badge-warning">Kepala Prodi</span>
                                                <?php
                                                                    } else {
                                                ?>
                                                    <span class="badge badge-info">Pengguna Lab</span>
                                                <?php
                                                                    }
                                                ?>
                                            </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="status" class="form-control" id="exampleInputEmail1" placeholder="Status" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="level" required>
                            ...
                            <option value="3">Pengguna Lab</option>
                        </select>
                    </div>
                </div>
            ...
            <form action="<?= base_url('admin/ckeloladata/updateuser/' . $value->id_user) ?>" method="POST">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">Status</label>
                            <input type="text" name="status" value="<?= $value->status ?>" class="form-control" id="exampleInputEmail1" placeholder="Status" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Username</label>
