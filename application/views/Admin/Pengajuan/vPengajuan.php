                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $row->alasan ?></td>
                                            <td class="text-center"><?php if ($row->status_pengajuan == '0') {
                                                                    ?>
                                                    <span class="badge badge-warning">Menunggu Konfirmasi Kaprodi</span>
                                                <?php
                                            ...
                                            <td class="text-center">
                                                ...
                                                ?>
                                                    <button type="button" data-toggle="modal" data-target="#detail<?= $row->id_pengajuan ?>" class="btn btn-info"><i class="fas fa-info"></i></button>
                                                <?php
                                                }
                                                ?>
