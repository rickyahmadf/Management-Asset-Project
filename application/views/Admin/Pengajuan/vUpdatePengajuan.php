                ...
                <div class="card card-outline card-danger">
                    ...
                    <div class="card-body pad">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="faktor form-control" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?= $pengajuan->faktor_penyebab ?></textarea>
