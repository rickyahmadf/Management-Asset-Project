                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><img width="150px" src="<?= base_url('asset/images/' . $value->kode_asset . '.png') ?>"><br>
                                                ...
                                                <div>
                                                <!-- <a href="<?= base_url('cAsset/qrcode_print/' .$value->id_asset)  ?>" target="_blank" class="btn btn-default btn-sm">
                                            ...
                                            <!-- <td><?= $value->merk ?> -->
                                        <br> <?php if ($value->status_dipinjam == '1') {
                                                                    ?>
                                                    <span class="badge badge-warning">Di Booking</span>
                                                <?php
