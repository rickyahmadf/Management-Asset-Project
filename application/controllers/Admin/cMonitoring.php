...
class cMonitoring extends CI_Controller
{
    ...
    public function create()
    {
        ...
        public function createhistori()
        {
                $data = array(
                    ...
                    'tgl_histori' => $this->input->post('tgl'),
                    'kondisi_pengecekan' => $this->input->post('kondisi'),
                );
                $this->mMonitoring->histori($data);
                $this->session->set_flashdata('success', 'Data Histori Berhasil Ditambahkan!');
                redirect('Admin/cMonitoring');
            }
    ...
    {
        $data = array(
            'monitoring' => $this->mMonitoring->getpengecekan($id),
            'histori' => $this->mMonitoring->select_histori($id)
        );
        $this->load->view('Admin/Layout/head');
        $this->load->view('Admin/Layout/aside');
        $this->load->view('Admin/Monitoring/vDetailMonitoring', $data);
        $this->load->view('Admin/Layout/footer');
    }
}
